...
Ввод через stdin. В первой строке ввода - кол-во элементов массива n (1 <= n <= 1e9). Во второй строке - номер статистики k, которую нужно определить (1 <= k <= n). Далее - n строк, содержащих целые числа a\_i (-1e9 <= a\_i <= 1e9).
